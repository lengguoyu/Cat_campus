...
void StartWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->introRequested(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (StartWidget::*)()>(_a, &StartWidget::startGameRequested, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (StartWidget::*)()>(_a, &StartWidget::introRequested, 1))
            return;
    }
}
...
// SIGNAL 0
void StartWidget::startGameRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void StartWidget::introRequested()
{
